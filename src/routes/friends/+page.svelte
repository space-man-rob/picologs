<script lang="ts">
	...
	import { Trash2, Copy, Check, X, Send, UserPlus } from '@lucide/svelte';
							...
							{#each incomingRequests as request (request.id)}
								...
								>
									<div class="flex items-center gap-4">
										...
										{:else}
											<div
												class="w-14 h-14 rounded-full bg-blue-600/20 flex items-center justify-center ring-2 ring-white/10"
											>
												<svg
													width="28"
													height="28"
			...
			<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
				...
				<div class="space-y-4">
					...
					<form
						...
						class="p-6 bg-overlay-card rounded-lg border border-white-10"
					>
						<div class="space-y-4">
							<div>
